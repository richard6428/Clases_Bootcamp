...
class FacturasControllerTest < ActionController::TestCase
  ...
  test "should create factura" do
    assert_difference('Factura.count') do
      post :create, factura: { Apellido: @factura.Apellido, Cedula: @factura.Cedula, Descuento: @factura.Descuento, Iva: @factura.Iva, Nombres: @factura.Nombres, Precio: @factura.Precio, Producto: @factura.Producto }
    end
  ...
  test "should update factura" do
    patch :update, id: @factura, factura: { Apellido: @factura.Apellido, Cedula: @factura.Cedula, Descuento: @factura.Descuento, Iva: @factura.Iva, Nombres: @factura.Nombres, Precio: @factura.Precio, Producto: @factura.Producto }
    assert_redirected_to factura_path(assigns(:factura))
  end
